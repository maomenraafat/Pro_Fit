...
const updateTraineeStepGoalForTrainer = catchAsyncError(async (req, res) => {
  ...
  if (trainee.assignedTrainer.toString() !== trainerId) {
      return res.status(403).json({
          success: false,
          message: "You are not authorized to update the step goal for this trainee.",
      });
  }
...
export { setGoal, recordSteps, getTodaySteps,updateTraineeStepGoalForTrainer,getTodayStepsForTrainer };
