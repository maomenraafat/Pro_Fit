...
const resetDailyStepsAndCalories = async () => {
    ...
    try {
        ...
        if (operations.length > 0) {
            ...
            console.log(`Reset daily steps and calories for ${operations.length} trainees.`);
        } else {
...
const job = new CronJob('0 0 * * *', resetDailyStepsAndCalories, null, true, 'Africa/Cairo');

// Start the cron job
job.start();

console.log('Cron job scheduled: Reset steps and calories at midnight Cairo time.');
